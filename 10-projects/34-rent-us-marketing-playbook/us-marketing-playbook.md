# 프로젝트렌트 US/LA 마케팅 플레이북

> 작성: 2026-07-05 (맥미니 무인 실행 — 섹션 4~7 초안 / 0~3·8은 뼈대만).
> 센터피스 데이터: [research/tool-la-alternatives.md](research/tool-la-alternatives.md)
> 모든 USD 수치는 3중 검증 원칙 적용, 불확실 수치는 [추정]/[확인필요] 태그.

---

## 0. Executive Summary (뼈대 — 사용자 취향판단 영역)

- 한 문장 논지: 경쟁력은 "채널"이 아니라 **오프라인 경험 설계·측정 방법론**. 채널은 LA로 치환, 방법론은 미국 Experience Economy에서 더 강한 무기.
- (TODO: 사용자 리뷰 후 3~5 불릿 확정)

## 1. 현재 상품 라인업 요약 (뼈대)

- 3패키지: Lite(최소 ₩300만) / Regular / Custom(+Option)
- 개별 상품 30여 개 — 8개 카테고리(A~H) 분류는 tool-la-alternatives.md 참조
- 검증 성과: CPM ₩501, CPC ₩13, TVC 대비 노출효율 4,539%, 브랜드 인지도 변화 94.1% (2024 가나·파친코·젠제로 기준)

## 2. 센터피스 — 상품별 LA 대안·가격 매핑 (뼈대)

- 본문: [research/tool-la-alternatives.md](research/tool-la-alternatives.md) (상품 30여 개 × LA 대안 × USD × 전이도★)
- (TODO: 사용자 리뷰 후 핵심 매핑 하이라이트를 이 섹션에 요약)

## 3. 전이도 분석 — 무엇이 살아남고 무엇이 죽는가 (뼈대)

- ★4~5 (그대로 전이): 자사 IG 운영, 사진/영상 프로덕션, 설문/리포트 방법론, People Counting
- ★2~3 (형태 변환 필요): 파워페이지→로컬 애그리게이터 스폰서, 보도자료→PR wire+피칭, 체험단→UGC gifting(FTC 공개 의무)
- ★1 (구조적 이식 불가): 침투 바이럴(astroturfing→FTC 리스크), 구매 유도 체험단(가짜 리뷰 규제), 토스류 리워드 푸시(대응물 부재)
- (TODO: 센터피스 표 확정 후 갱신)

## 4. 미국 Experiential/Retail Media 시장

### 4.1 시장 규모 (출처별 병기 — 정의 차이로 수치 상이)

**Experiential Marketing** — 헤드라인 수치는 PQ Media 기준 권장(인용 빈도·포괄성 최고):
- 글로벌 2024년 **$128.35B**(+10.5%, 2019년 피크 $121.87B 최초 상회) → 2025년 **$138.94B**(+8.3%; B2C $97.24B / B2B $41.74B) — https://www.pqmedia.com/product/global-b2c-b2b-experiential-marketing-forecast-2024-2028/
- **미국 2025년 $64.43B**(+9.0%, 글로벌의 46.4% = 세계 최대 시장). 2026년은 동계올림픽·FIFA 월드컵 효과로 **+11.8% 가속 전망** — https://www.insideaudiomarketing.com/post/pq-media-u-s-leads-global-experiential-marketing-growth
- 각주: Cognitive Market Research(서비스 시장 협의) 글로벌 2024 $49.59B / Grand View(몰입기술 세그먼트만) 2024 $1.897B→2030 $9.29B, CAGR 31.4% — 정의가 달라 직접 비교 불가.
...
### 4.3 Experience Economy 수치 (신뢰도 검증 완료)

- "밀레니얼 78%가 물건보다 경험 선호" — 원 출처 Eventbrite×Harris Poll, **2014년 조사**(성인 2,083명). 수치는 정확하나 12년 된 데이터임을 명기하고 사용 — https://eventbrite-s3.s3.amazonaws.com/marketing/Millennials_Research/Gen_PR_Final.pdf
- 팝업 리테일 "$80B" 시장 — 신뢰도 **낮음~중간 [확인필요]**: 원류는 PopUp Republic(2014~2016)의 광의 임시 리테일 추정(플리마켓·푸드트럭 포함), 팝업숍 협의로는 ~$10B. 방법론 미공개. 플레이북에는 "**$10B(협의)~$80B(광의, 출처 신뢰도 제한적)**" 병기 — https://capitaloneshopping.com/research/pop-up-retail-statistics/

## 5. 규제·실무 (TCPA/CAN-SPAM/CCPA/OOH 퍼밋/FTC)
...
- **결론: 전부 설문(자기보고) 의존 또는 엔터프라이즈 커스텀. People Counting 하드웨어(특허)+행동 데이터+SNS 진정성 분석을 결합한, 팝업 단위 셀프서브 표준화 지수는 공백 영역.**

### 6.7 신규 상품화 기회 (초안)
1. **"Popup CRM Kit"**: Luma(무료~$59/월)+Klaviyo($35/월~)+PassKit($39.50/월) 턴키 — 도구 원가 월 $150 미만으로 월 $2~5K 매니지드 서비스 마진 구조.
2. **TCPA 컴플라이언스 자체가 상품**: 건당 $500~1,500 소송 리스크를 "컴플라이언트 리드 캡처 운영대행"으로 판매 — 명확한 차별화.
3. **People Counting × CRM 전환율 풀퍼널 스코어**: 방문자수(특허 실측)→QR 스캔율→옵트인율→구매 전환 — AnyRoad도 설문 기반 BXP도 못 하는 영역. Cultural Engagement Score를 이 공백에 꽂는다.
4. **NFC 웨어러블 스탬프랠리**: 밴드 개당 $0.4~1+패스 1센트 미만의 극저원가로 성수동식 멀티브랜드 스탬프투어를 Melrose/Arts District에 이식 — Bandwango가 비운 브랜드 팝업용 시장.
5. **Post-Popup Retention 애드온**: 수집 리드를 브랜드 Klaviyo/Smile.io로 이관+첫 90일 플로우 세팅 — 팝업 단발성 비판에 대한 답이자 recurring revenue 장치.

## 7. US 리포지셔닝 — Experience → Engagement → Data → CRM → Community

**논지: 한국에서 "바이럴 대행"으로 팔던 것을, 미국에서는 "측정 가능한 경험 마케팅 플랫폼"으로 판다.**

미국 시장에서 프로젝트렌트의 상품 서사를 5단 사다리로 재구성한다:

1. **Experience (입구)** — 팝업/경험 설계 역량은 그대로 수출. 단, 미국 클라이언트의 언어는 "바이럴"이 아니라 "experiential activation"·"brand experience". 성수동 300회 운영 이력 + 오픈런 창출 사례(가나·파친코)는 그대로 크리덴셜.
2. **Engagement (차별점 1)** — 한국식 패키지의 실체는 채널 믹스였지만, 미국 재포장은 "인게이지먼트 설계": 방문객이 체류·참여·공유하게 만드는 콘텐츠 설계. 미국 experiential 에이전시 대비 강점은 리테일(판매) 결합 — 단순 브랜드 스턴트가 아니라 매출이 찍히는 경험.
3. **Data (차별점 2 — 핵심 무기)** — People Counting 특허 + 옴니채널 분석. 미국은 Placer.ai(추정 데이터)·RetailNext(대형 리테일러용)가 장악했지만 "팝업/단기 이벤트 전용 실측 측정 + 리포트"는 공백. 한국에서 ₩30~60만에 팔던 리포트를 미국에서는 "event impact measurement" 상품으로 승격(미국 experiential 업계의 만성 약점 = ROI 증명).
...
## 8. 실행 로드맵 (뼈대 — 사용자 취향판단 영역)

- Phase 0: 견적 수집(RFQ 리스트 — tool-la-alternatives.md의 RFQ 표기 항목), 인허가 체크리스트(섹션 5)
- Phase 1: 파일럿 팝업 1회 (자사 측정 스택 풀 가동 → 케이스 스터디화)
- Phase 2: 로컬 미디어/인플루언서 네트워크 구축
- Phase 3: RaaS 플랫폼화
- (TODO: 사용자 리뷰 후 확정)
